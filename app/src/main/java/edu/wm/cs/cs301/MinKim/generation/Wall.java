...
import edu.wm.cs.cs301.MinKim.gui.MazeFileWriter;
import edu.wm.cs.cs301.MinKim.gui.P7PanelF22;
...
public class Wall {
    ...
    public Wall(final int startX, final int startY, final int extensionX, final int extensionY,
        ...
        seen = false;
        // determine color
        setColor(P7PanelF22.getWallColor(distance, cc, getExtensionX()));
