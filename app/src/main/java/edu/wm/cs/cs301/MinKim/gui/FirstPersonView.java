...
import edu.wm.cs.cs301.MinKim.generation.BSPBranch;
import edu.wm.cs.cs301.MinKim.generation.BSPLeaf;
import edu.wm.cs.cs301.MinKim.generation.BSPNode;
import edu.wm.cs.cs301.MinKim.generation.Floorplan;
import edu.wm.cs.cs301.MinKim.generation.Wall;
...
public class FirstPersonView {
	 ...
	 */
	public FirstPersonView(MazePanel mazePanel, int width, int height, int mapUnit, int stepSize, Floorplan seenWalls, BSPNode bspRoot) {
		...
		mazePanel.setDimensions(viewWidth, viewHeight);
